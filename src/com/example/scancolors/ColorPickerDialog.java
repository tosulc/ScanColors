...
//class Creator: http://v4all123.blogspot.com/2013/06/simple-colorpicker-for-android.html. Thanks.
//Little modification to work with my code.
public class ColorPickerDialog extends Dialog {
	public static int boja;
	public interface OnColorChangedListener {
		void colorChanged(String key, int color, int boja);
	}
	...
	public ColorPickerDialog(Context context, OnColorChangedListener listener,
			String key, int initialColor, int defaultColor, int boja) {
		super(context);
		ColorPickerDialog.boja = boja;
		mListener = listener;
		mKey = key;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		OnColorChangedListener l = new OnColorChangedListener() {
			public void colorChanged(String key, int color, int boja) {
				mListener.colorChanged(mKey, color, boja);
				dismiss();
			}
		};
